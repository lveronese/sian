 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="Vasi" type="{http://cooperazione.sian.it/schema/wsmrga/}VasoVinario" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "VasiSiRPVInput")
public class VasiSiRPVInput {
    ...
    @XmlElement(name = "Vasi", required = true)
    protected List<VasoVinario> vasi;
     ...
     * 
     */
    public List<VasoVinario> getVasi() {
        if (vasi == null) {
            vasi = new ArrayList<VasoVinario>();
        }
        return this.vasi;
    }
