 ...
 *         &lt;element name="VasiOutput" type="{http://cooperazione.sian.it/schema/wsmrga/}VasoVinarioOutput" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetCancVasiSiRPVOutput")
public class GetCancVasiSiRPVOutput {
    ...
    @XmlElement(name = "VasiOutput")
    protected List<VasoVinarioOutput> vasiOutput;
    ...
    /**
     * Gets the value of the vasiOutput property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the vasiOutput property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVasiOutput().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<VasoVinarioOutput> getVasiOutput() {
        if (vasiOutput == null) {
            vasiOutput = new ArrayList<VasoVinarioOutput>();
        }
        return this.vasiOutput;
    }
