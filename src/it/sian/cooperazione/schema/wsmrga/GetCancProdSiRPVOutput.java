 ...
 *         &lt;element name="EliminaProdOutput" type="{http://cooperazione.sian.it/schema/wsmrga/}EliminaProdCatalogoOutput" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetCancProdSiRPVOutput")
public class GetCancProdSiRPVOutput {
    ...
    @XmlElement(name = "EliminaProdOutput")
    protected List<EliminaProdCatalogoOutput> eliminaProdOutput;
    ...
    /**
     * Gets the value of the eliminaProdOutput property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the eliminaProdOutput property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEliminaProdOutput().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EliminaProdCatalogoOutput }
     * 
     * 
     */
    public List<EliminaProdCatalogoOutput> getEliminaProdOutput() {
        if (eliminaProdOutput == null) {
            eliminaProdOutput = new ArrayList<EliminaProdCatalogoOutput>();
        }
        return this.eliminaProdOutput;
    }
