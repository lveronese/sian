 ...
 *         &lt;element name="Vigne" type="{http://cooperazione.sian.it/schema/wsmrga/}VignaOutput" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetVigneSiRPVOutput")
public class GetVigneSiRPVOutput {
    ...
    @XmlElement(name = "Vigne")
    protected List<VignaOutput> vigne;
     ...
     * 
     */
    public List<VignaOutput> getVigne() {
        if (vigne == null) {
            vigne = new ArrayList<VignaOutput>();
        }
        return this.vigne;
    }
