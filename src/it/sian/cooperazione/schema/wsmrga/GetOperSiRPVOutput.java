 ...
 *         &lt;element name="ControlloEsito" type="{http://cooperazione.sian.it/schema/wsmrga/}ControlloEsito" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetOperSiRPVOutput")
public class GetOperSiRPVOutput {
    ...
    @XmlElement(name = "ControlloEsito")
    protected List<ControlloEsito> controlloEsito;
    ...
    /**
     * Gets the value of the controlloEsito property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the controlloEsito property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getControlloEsito().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ControlloEsito> getControlloEsito() {
        if (controlloEsito == null) {
            controlloEsito = new ArrayList<ControlloEsito>();
        }
        return this.controlloEsito;
    }
