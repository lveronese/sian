 ...
 *         &lt;element name="Soggetto" type="{http://cooperazione.sian.it/schema/wsmrga/}SoggettoOutput" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetSoggSiRPVOutput")
public class GetSoggSiRPVOutput {
    ...
    protected List<SoggettoOutput> soggetto;
     ...
     * 
     */
    public List<SoggettoOutput> getSoggetto() {
        if (soggetto == null) {
            soggetto = new ArrayList<SoggettoOutput>();
        }
